...
client.on("ready", async () => {
  ...
  client.user.setActivity(`${prefix}help | By TIGER`, { type: "PLAYING" });
...
⚡ | Moderation Commands
 ...
 __ [SUPPORT](https://discord.gg/sghNdjQnEK) __ - __ [INVITE](https://discord.com/api/oauth2/authorize?client_id=834587684432379914&permissions=8&scope=bot) __
`);
